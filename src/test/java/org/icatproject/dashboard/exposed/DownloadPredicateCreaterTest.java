...
// import static
// org.icatproject.dashboard.exposed.PredicateCreater.createDownloadLocationPredicate;
// import static
// org.icatproject.dashboard.exposed.PredicateCreater.createDownloadPredicate;
...
//
// ICATUser testUser = new ICATUser(true, new Long(1), "Bobby McBobFace",
// "uows/1");
...
//
// GeoLocation location1 = new GeoLocation(51.2, -41.3, "GB", "Towny
// McTownFace", "Internet");
// GeoLocation location2 = new GeoLocation(52.2, -41.3, "GB", "Town Land",
// "Internet");
// GeoLocation location3 = new GeoLocation(54.2, -41.2, "GB", "Town upton Town",
// "Internet");
//
...
//
//
// Download download1 = new Download(location1, testUser, "",
// convertToDate(LocalDate.now().minusDays(11)), convertToDate(LocalDate.now()),
// "https", new Long(10), 10.34, 10000, "finished", 10);
// Download download2 = new Download(location2, testUser, "",
// convertToDate(LocalDate.now().minusDays(12)),
// convertToDate(LocalDate.now().minusDays(4)), "globus", new Long(10), 10.34,
// 10000, "finished", 10);
// Download download3 = new Download(location3, testUser, "",
// convertToDate(LocalDate.now().minusDays(4)),
// convertToDate(LocalDate.now().minusDays(3)), "scarf", new Long(10), 10.34,
// 10000, "finished", 10);
// Download download4 = new Download(location1, testUser2, "",
// convertToDate(LocalDate.now().minusDays(2)), convertToDate(LocalDate.now()),
// "scarf", new Long(10), 10.34, 10000, "finished", 10);
// Download download5 = new Download(location2, testUser2, "",
// convertToDate(LocalDate.now().minusDays(20)),
// convertToDate(LocalDate.now().minusDays(15)), "scarf", new Long(10), 10.34,
// 10000, "finished", 10);
//
...
//
// CriteriaQuery<Object> cq = getDownloadCriteriaQuery("undefined",
// "undefined");
//
...
// private CriteriaQuery<Object> getGeoLocationCriteriaQuery(String userName,
// String method) {
...
// Join<Download, GeoLocation> downloadLocationJoin =
// geoLocation.join("downloads");
//
// //Get methods and count how many their are.
// query.multiselect(geoLocation);
//
// Predicate finalPredicate = createDownloadLocationPredicate(cb, start, end,
// downloadLocationJoin, userName, method);
//
...
// private CriteriaQuery<Object> getDownloadCriteriaQuery(String userName,
// String method) {
//
// LocalDate now = LocalDate.now();
// LocalDate before = now.minusDays(10);
...
//
// Predicate finalPredicate = createDownloadPredicate(cb, start, end, download,
// userJoin, userName, method);
//
