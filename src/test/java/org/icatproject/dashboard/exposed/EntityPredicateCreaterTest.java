...
//		return ShrinkWrap.create(WebArchive.class, "test.war").addPackage(InvestigationMetaData.class.getPackage())
//				.addPackage(InstrumentMetaData.class.getPackage()).addPackage(EntityCount.class.getPackage())
//				.addPackage(DashboardException.class.getPackage()).addClass(PredicateCreater.class)
//				.addPackage(DateUtility.class.getPackage())
//				.addAsResource("test-persistence.xml", "META-INF/persistence.xml").addAsWebInfResource("web.xml")
...
//
//		InstrumentMetaData ins1 = new InstrumentMetaData(new Long(10), new Long(10000), convertToDate(today),
//				new Long(1));
//		InstrumentMetaData ins2 = new InstrumentMetaData(new Long(20), new Long(10000),
//				convertToDate(today.minusDays(10)), new Long(3));
//		InstrumentMetaData ins3 = new InstrumentMetaData(new Long(30), new Long(30000), convertToDate(today),
//				new Long(2));
//		InstrumentMetaData ins4 = new InstrumentMetaData(new Long(40), new Long(50000),
//				convertToDate(today.minusDays(3)), new Long(1));
//
//		ins1.preparePersist();
//		ins2.preparePersist();
//		ins3.preparePersist();
...
//		InvestigationMetaData inv3 = new InvestigationMetaData(new Long(6), new Long(10000),
//				convertToDate(today.minusDays(1)), 3);
//		InvestigationMetaData inv4 = new InvestigationMetaData(new Long(10), new Long(10000),
//				convertToDate(today.minusDays(10)), 1);
//
//		inv1.preparePersist();
//		inv2.preparePersist();
//		inv3.preparePersist();
...
//
//		Predicate finalPredicate = getEntityCountPredicate(cb, entityCount, convertToDate(today), convertToDate(before),
//				"Instrument");
//
